...
class MockChannels {
  setupMockChannel() {
    const MethodChannel flutterSecureStorage = MethodChannel(
      'plugins.it_nomads.com/flutter_secure_storage',
    );

    const MethodChannel flutterAppauth = MethodChannel(
    ...
    const MethodChannel customTabs = MethodChannel(
    ...
    TestWidgetsFlutterBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(customTabs, (MethodCall methodCall) async {
          return null;
        });
  }
}
