    ...
    (new Serializers().toBuilder()
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(AddOrganizationUsersRequestUsersInner),
            ]),
            () => new ListBuilder<AddOrganizationUsersRequestUsersInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(ApiApplicationsInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(CreateUserRequestIdentitiesInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(OrganizationUserPermission),
            ]),
            () => new ListBuilder<OrganizationUserPermission>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(OrganizationUserPermissionRolesInner),
            ]),
            () => new ListBuilder<OrganizationUserPermissionRolesInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(OrganizationUserRole),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(RedirectCallbackUrls),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(UserIdentitiesInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(SubscribersSubscriber),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(UpdateOrganizationUsersRequestUsersInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(UsersResponseUsersInner),
            ]),
